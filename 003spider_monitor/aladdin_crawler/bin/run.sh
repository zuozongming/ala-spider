...
$PYTHON_BIN merge_crawler_result.py -q ${query_file_path} -r ${crawler_result_file_path} -o ${result_file_path}
md5sum ${result_file_path} > ${result_file_path}".md5"
rm ${crawler_result_file_path}
