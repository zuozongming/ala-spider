...
Author: mport ConfigParserlyudonglee(yudonglee@baidu.com)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", dest = "query_file_path", required = True, help = "监控query")
    ...
    for line in query_file_handler:
        ...
        env_dict = {}
        env_dict['online'] = {}
        env_dict['online']['url_param'] = 'sid=1'
        env_dict['sample'] = {}
        env_dict['sample']['url_param'] = 'sid=5581'
